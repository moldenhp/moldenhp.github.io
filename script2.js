...
document.getElementById("word2").addEventListener('click', function (event){
	var req= new XMLHttpRequest();
	var searchWord = document.getElementById("textBox2").value;
		...
		if(req.status >=200 && req.status < 400){
			...
			function gotData(response){
				...
				for (var i = 0; i < articles.length; i++){
					...
					var bigT = document.createElement("h2"); // create h1 element 
